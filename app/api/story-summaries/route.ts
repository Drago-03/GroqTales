...
/**
 * @api {post} /api/story-summaries Generate and store a summary for a story
 */
...
/**
 * @api {get} /api/story-summaries Get summaries, optionally filtered by storyId
 */
...
/**
 * @api {put} /api/story-summaries/:id Update a story summary
 */
...
/**
 * @api {delete} /api/story-summaries/:id Delete a story summary
 */
