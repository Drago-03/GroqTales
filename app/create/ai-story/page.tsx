      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Generate unique stories using Groq's powerful language models and
            mint them as NFTs on the Monad blockchain
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-muted-foreground">
                Create NFTs on Monad blockchain
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 p-6 border rounded-xl bg-muted/30">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              The AI Story Generator uses Groq's advanced language models to
              create unique stories based on your prompts. These stories can be
              immediately minted as NFTs on the Monad blockchain, creating
              provable ownership and authenticity.
            </p>
            <p>
              <strong>How it works:</strong> Enter a prompt, select your
              preferred AI model and settings, and generate a story. You can
              then mint this story as an NFT directly from the interface,
              creating a permanent record of your creation on the blockchain.
            </p>
            <p>
              <strong>Note:</strong> To mint NFTs, you'll need to connect a
              compatible Web3 wallet and ensure it's configured for the Monad
              network.
            </p>
          </div>
        </div>
