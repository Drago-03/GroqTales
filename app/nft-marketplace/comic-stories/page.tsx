...
import { Filter, Sparkles, BookOpen, ShoppingCart, Heart, Eye } from "lucide-react";
...
const mockComicNFTs: ComicNFT[] = [
  {
    ...
    authorAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=ComicArtist42",
    coverImage: "https://images.unsplash.com/photo-1605457867610-e990b283a2a0?w=800&h=1200&fit=crop&q=80",
    price: "0.45 ETH",
    likes: 763,
    views: 3210,
    pages: 24,
    genre: "Sci-Fi",
    rarity: "rare",
    description: "A team of superheroes with quantum abilities must save the multiverse from collapse.",
    previewImages: [
  ...
  },
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1626379616459-b2ce1d9decbc?w=800&h=1200&fit=crop&q=80",
    price: "0.32 ETH",
    likes: 542,
    views: 2150,
    pages: 18,
    genre: "Cyberpunk",
    rarity: "uncommon",
    description: "In a neon-lit dystopian future, a hacker uncovers a conspiracy that could change everything.",
    previewImages: [
  ...
  },
  {
    ...
    authorAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=FantasyDrawer",
    coverImage: "https://images.unsplash.com/photo-1534809027769-b00d750a6bac?w=800&h=1200&fit=crop&q=80",
    price: "0.58 ETH",
    likes: 891,
    views: 4120,
    pages: 32,
    genre: "Fantasy",
    rarity: "legendary",
    description: "A journey through magical realms where ancient myths come to life.",
    previewImages: [
  ...
  },
  {
    ...
    authorAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=GalacticArtist",
    coverImage: "https://images.unsplash.com/photo-1543872084-c7bd3822856f?w=800&h=1200&fit=crop&q=80",
    price: "0.29 ETH",
    likes: 420,
    views: 1850,
    pages: 16,
    genre: "Space Opera",
    rarity: "common",
    description: "Adventures of a band of space pirates as they navigate the dangers of the cosmic frontier.",
    previewImages: [
  ...
  },
  {
    ...
    author: "MysteryMaker",
    authorAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=MysteryMaker",
    coverImage: "https://images.unsplash.com/photo-1519791883288-dc8bd696e667?w=800&h=1200&fit=crop&q=80",
    price: "0.37 ETH",
    likes: 632,
    views: 2740,
    pages: 22,
    genre: "Mystery",
    rarity: "uncommon",
    description: "A hard-boiled detective navigates the dark alleys of a crime-ridden city to solve an impossible case.",
    previewImages: [
  ...
  },
  {
    ...
    authorAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=HistoryIllustrator",
    coverImage: "https://images.unsplash.com/photo-1515119678297-471fcf6fe40c?w=800&h=1200&fit=crop&q=80",
    price: "0.41 ETH",
    likes: 712,
    views: 3080,
    pages: 28,
    genre: "Historical",
    rarity: "rare",
    description: "Epic tales of honor and battle in the age of samurai and warring clans.",
    previewImages: [
...
export default function ComicStoriesPage() {
  ...
  const [selectedRarity, setSelectedRarity] = useState<ComicNFT["rarity"] | null>(null);
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="flex items-center">
              ...
              <select
                ...
                onChange={(e) => setSelectedRarity((e.target.value || null) as ComicNFT["rarity"] | null)}
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">
            {filteredComics.length} {filteredComics.length === 1 ? 'Comic' : 'Comics'} Available
          </h2>
        ...
        {filteredComics.length === 0 ? (
          ...
          >
            <p className="text-muted-foreground">No comics found matching your criteria. Try adjusting your filters.</p>
          </motion.div>
        ) : (
          <motion.div
                ...
                >
                  <Card className="h-full overflow-hidden relative group">
                    ...
                    <CardFooter className="p-4 pt-0 flex items-center justify-between">
                      ...
                      <div className="font-bold text-amber-600">{comic.price}</div>
                    </CardFooter>
                  </Card>
                </motion.div>
              ))}
