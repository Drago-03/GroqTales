...
import { PenLine, ImagePlus } from "lucide-react";
  ...
  return (
    <>
      <Button onClick={() => setOpen(true)} size="lg" className="theme-gradient-bg text-white border-0 hover:opacity-90">
        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <Tabs defaultValue="text" className="mt-4">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="image" className="data-[state=active]:theme-gradient-bg data-[state=active]:text-white">
