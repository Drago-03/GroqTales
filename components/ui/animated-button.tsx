...
export const NFTButton = React.forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  ({ children, className, animationType = "scale", ...props }, ref) => {
    return (
      <AnimatedButton
        ref={ref}
        className={cn("bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500", className)}
...
export const StoryButton = React.forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  ({ children, className, animationType = "scale", ...props }, ref) => {
    return (
      <AnimatedButton
        ref={ref}
        className={cn("bg-gradient-to-r from-cyan-500 via-teal-500 to-emerald-500", className)}
...
export const PrimaryAnimatedButton = React.forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  ({ children, className, animationType = "pulse", ...props }, ref) => {
    return (
      <AnimatedButton
        ref={ref}
        className={cn("bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600", className)}
...
export const GroqButton = React.forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  ({ children, className, animationType = "xy", ...props }, ref) => {
    return (
      <AnimatedButton
        ref={ref}
        className={cn("bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500", className)}
