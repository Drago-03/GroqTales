  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "There was an error analyzing your story. Please try again.",
        variant: "destructive"
      });
    } finally {
    ...
    <div className={`space-y-6 ${className}`}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Analyze your story for themes, sentiment, structure, and get improvement suggestions.
          </CardDescription>
        </CardHeader>
              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground mt-1">Readability</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">{analysis.themes.length}</div>
                ...
                <div className="space-y-3">
                  {Object.entries(analysis.structure).map(([key, value]) => (
                    <div key={key} className="flex justify-between items-center">
                      ...
                      <Badge variant={value === 'Strong' ? 'default' : value === 'Good' ? 'secondary' : 'outline'}>
                        {value as string}
                      </Badge>
                    </div>
                  ))}
