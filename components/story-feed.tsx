...
const communityStories: Story[] = [
  ...
  },
  {
    ...
    author: {
      name: "MapMaker42",
      avatar: "https://images.unsplash.com/photo-1618077360395-f3068be8e001?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
      ...
      <div className="relative h-48 w-full">
        ...
        {story.isNft && (
          <div className="absolute top-2 right-2">
            <Badge variant="secondary" className="bg-primary/80 hover:bg-primary text-primary-foreground">
              NFT
            </Badge>
          </div>
        )}
