...
export const topNftStories = [
  {
    ...
    views: 8754,
    genre: "fantasy",
    description: "A tale of a young hero who discovers they are the last of an ancient order of guardians with the power to save their world from darkness.",
    isTop10: true,
    sales: 142
  },
  {
    ...
    views: 6152,
    genre: "sci-fi",
    description: "In the far reaches of the galaxy, a mysterious signal begins repeating from a dead star, drawing explorers and dangers alike.",
    isTop10: true,
    sales: 98
  },
  {
