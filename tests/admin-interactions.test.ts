...
import { isAdminLoggedIn, performAdminAction, getAdminActions, clearAdminActions } from "../lib/admin-service";
...
describe('Admin Actions History', () => {
  ...
  test('getAdminActions returns actions in reverse chronological order', async () => {
    ...
    await performAdminAction({ type: 'comment', storyId: 'story-2', content: 'Great story!' });
