...
/**
 * React component providing an interface for generating AI-powered stories from user prompts.
 *
 * Renders a form for user input, submits prompts to a serverless backend for story generation, displays the streamed story output, and allows copying the generated story to the clipboard with visual feedback.
 */
function App() {
