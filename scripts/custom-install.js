...
try {
  ...
  if (missingDeps.length > 0) {
    ...
    if (missingDeps.includes('@radix-ui/react-tooltip')) {
      log('Attempting to manually download @radix-ui/react-tooltip from unpkg...');
      try {
        execSync('curl -s https://unpkg.com/@radix-ui/react-tooltip@1.0.7/dist/index.js -o node_modules/@radix-ui/react-tooltip/index.js', { stdio: 'inherit' });
        ...
        fs.writeFileSync('node_modules/@radix-ui/react-tooltip/package.json', JSON.stringify(packageJson, null, 2));
